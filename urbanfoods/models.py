...
class PaymentAttempt(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            ...
            models.CheckConstraint(check=models.Q(expected_amount__gt=0),
                name='payment_attempt_positive_expected_amount',
            ),
            models.CheckConstraint(check=models.Q(received_amount__isnull=True) | models.Q(received_amount__gte=0),
