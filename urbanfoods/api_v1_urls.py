...
partner_patterns = [
    ...
    path('revenue-share/', api_v1_partner_views.RevenueSharingView.as_view(), name='partner_revenue_share'),
    path('revenue-share/gate/', api_v1_partner_views.VerifyRevenueGateView.as_view(), name='partner_revenue_gate'),
    path('settings/', api_v1_partner_views.StoreSettingsView.as_view(), name='partner_settings'),
    path('franchise/branches/', api_v1_partner_views.FranchiseBranchesView.as_view(), name='partner_franchise_branches'),
...
urlpatterns = [
    ...
    path('directions/', api_v1_rider_views.DirectionsView.as_view(), name='directions'),
