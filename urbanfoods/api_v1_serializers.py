...
class PromotionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Promotion
        fields = [
            'id', 'title', 'description', 'code', 'discount_percentage',
            'discount_amount', 'min_order_amount', 'usage_limit',
            'start_date', 'end_date', 'is_active', 'times_used', 'total_saved'
        ]
        read_only_fields = ['store', 'times_used']

    def get_total_saved(self, obj):
        # Calculate total discount generated by this promotion across all orders
        # sum(discount_amount) for orders using this promo code
